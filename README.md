...
Текущий код существующего репозитория команды в этом архиве не проверялся и не изменялся.
Не копируйте архив поверх уже реализованных ai/backend/frontend без сравнения и адаптации.
