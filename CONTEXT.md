...
Текущий порядок работы в одном каталоге и фактический статус: docs/START_HERE.md. Старые указания про работу и merge отдельных веток ниже не применяются.
